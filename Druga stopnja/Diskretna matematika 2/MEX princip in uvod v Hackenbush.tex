...
\begin{document}
	...
	Navedimo nekaj znanih nepristranskih iger, ki nas bodo zanimale.
	
	\begin{definicija}
		\label{def:impartialgames}
		\begin{itemize}
			\item V igri \pojem{Reži} igralca Lea in Drago režeta mrežasto ploščo velikosti $m\times n$, ki je v skrajno spodnjem levem kvadratku pritrjena na stojalo. Ko je igralec na vrsti, izbere bodisi nek stolpec in ga s tem odreže (odstrani) skupaj z vsemi stolpci, ki so desno od njega, bodisi izbere neko vrstico in jo s tem odreže skupaj z vsemi vrsticami, ki so nad izbrano. Pri tem ne more izbrati stolpca oz. vrstice, ki vsebuje kvadratek, ki je pritrjen na stojalo. Zmaga tisti igralec, ki zadnji opravi dopusten rez.
			
			\item V igri \pojem{Pobiranje opek} igralca Lea in Drago pobirata opeke s kupa $k$-tih opek. Ko je na vrsti, igralec pobere eno ali pa dve opeki. Zmaga tisti, ki je zadnji pobral kako opeko.
			
			\item V igri \pojem{Nim} igralca Lea in Drago pobirata kamenčke s $k$-tih kupov. Ko je na vrsti, igralec izbere kup in z njega pobere poljubno število kamenčkov (najmanj enega, največ vse na kupu). Zmaga tisti igralec, ki je zadnji pobral kamenček.
		\end{itemize}
	\end{definicija}
	\begin{definicija}
	...
	Za začetek z $\bullet 0$ označimo pozicijo v igri, v kateri ni nobenih povezav. Na podlagi znanih rezultatov o $\equiv$ vidimo, da velja naslednja trditev:
	...
	Za konec še premislimo obstoj Hackenbush pozicij z vrednostjo ulomka.
	...
	Za konec navedimo še en rezultat, ki bi nam prišel prav v nadaljni analizi igre.
