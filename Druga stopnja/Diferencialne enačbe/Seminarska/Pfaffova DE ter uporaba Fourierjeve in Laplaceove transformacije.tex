		...
		\subsection{Osnovne definicije in rezultati}
			...
			\begin{trd}
				...
				Za Laplaceovo transformacijo veljajo naslednje lastnosti: \begin{enumerate}
					...
					\item Če $\mathcal{L}(tf(t))(z)$ in $\mathcal{L}(f(t))(z)$ obstajata, potem je $\frac{d}{dz}(\mathcal{L}(f(t))(z)) = -\mathcal{L}(tf(t))(z)$. Dodatno, če obstajajo $\mathcal{L}(t^kf(t))(z),~\forall k\in\No$, velja: $$\frac{d^k}{dz^k}(\mathcal{L}(f(t))(z)) = (-1)^k\mathcal{L}(t^kf(t))(z)$$
				\end{enumerate}
			\end{trd}
